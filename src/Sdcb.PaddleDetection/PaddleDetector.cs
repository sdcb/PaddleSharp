...
/// <summary>
/// Class for detecting objects using PaddleDetection API.
/// </summary>
public class PaddleDetector : IDisposable
{
    ...
    /// <summary>
    /// Config object that contains the configuration of the PaddleDetector model.
    /// </summary>
    public DetectionModelConfig Config { get; }

    /// <summary>
    /// Creates a new instance of PaddleDetector using the provided PaddleConfig and configYmlPath.
    /// </summary>
    /// <param name="config">The PaddleConfig object to use for configuration.</param>
    /// <param name="configYmlPath">The path to the Yaml config file to use.</param>
    /// <param name="configure">The action to execute to configure the PaddleConfig before creating the PaddlePredictor.</param>
    ...
    /// <summary>
    /// Creates a new instance of PaddleDetector using the provided PaddlePredictor and configYmlPath.
    /// </summary>
    /// <param name="predictor">The PaddlePredictor object to use for the prediction.</param>
    /// <param name="configYmlPath">The path to the Yaml config file to use.</param>
    ...
    /// <summary>
    /// Creates a new instance of PaddleDetector using the provided model directory and configYmlPath.
    /// </summary>
    /// <param name="modelDir">The path to the model directory to use for prediction.</param>
    /// <param name="configYmlPath">The path to the Yaml config file to use.</param>
    /// <param name="configure">The action to execute to configure the PaddleConfig before creating the PaddlePredictor.</param>
    ...
    /// <summary>
    /// Disposes the PaddlePredictor object used by this instance of PaddleDetector.
    /// </summary>
    public void Dispose()
    {
        _p.Dispose();
    ...
    /// <summary>
    /// Runs the detection on the provided image.
    /// </summary>
    /// <param name="src">The image to run the detection on.</param>
    /// <returns>An array of DetectionResult objects representing the detected objects.</returns>
    ...
    /// <summary>
    /// Visualizes the detected objects on the source image and returns the resulting image. 
    /// </summary>
    /// <param name="src">The source image.</param>
    /// <param name="results">List of detection results.</param>
    /// <param name="labelCount">The number of labels.</param>
    /// <returns>The resulting image with the detected objects.</returns>
