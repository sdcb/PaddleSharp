...
static ProjectVersion[] Projects = new[]
{
	...
	new ProjectVersion("Sdcb.PaddleOCR", "2.6.0.6-preview.2"), 
	new ProjectVersion("Sdcb.PaddleOCR.Models.Online", "2.6.0.6-preview.2"), 
	new ProjectVersion("Sdcb.PaddleOCR.Models.LocalV3", "2.6.0.6-preview.2"), 
